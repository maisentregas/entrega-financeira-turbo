...
import { Building2, User, Clock, TrendingDown, Eye, Zap, FileText, CreditCard } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-primary">Para a empresa (cliente)</h3>
              </div>
            </div>
            
            <div className="space-y-4">
              {companyBenefits.map((benefit, index) => <Card key={index} className="p-6 bg-primary-light/50 border-primary/20 hover:shadow-card transition-all duration-200 animate-fade-in" style={{
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {deliveryBenefits.map((benefit, index) => <Card key={index} className="p-6 bg-success-light/50 border-success/20 hover:shadow-card transition-all duration-200 animate-fade-in" style={{
              animationDelay: `${index * 0.1}s`
            }}>
                  <div className="flex items-start gap-4">
